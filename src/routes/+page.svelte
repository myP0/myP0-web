...
<div class="font-[Inter,system-ui,sans-serif]">
		...
		<div class="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
			...
			<div class="flex items-center gap-3">
				<a
					...
					class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm text-zinc-400 transition-colors hover:text-white"
				>
				...
				<a
					href="/dashboard"
					class="rounded-lg bg-white px-4 py-2 text-sm font-medium text-zinc-950 transition-colors hover:bg-zinc-200"
				>
					Get started
				</a>
			</div>
	...
	<section class="relative overflow-hidden pt-32 pb-20 md:pt-44 md:pb-32">
		<!-- Subtle radial glow -->
		<div class="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 h-[600px] w-[800px] rounded-full bg-zinc-800/20 blur-[120px]"></div>

		<div class="relative mx-auto max-w-4xl px-6 text-center">
			<!-- Badge -->
			<div class="mb-8 inline-flex items-center gap-2 rounded-full border border-zinc-800 bg-zinc-900/50 px-4 py-1.5">
				<div class="h-1.5 w-1.5 rounded-full bg-emerald-500"></div>
				<span class="text-xs font-medium text-zinc-400">Open source & privacy-first</span>
			</div>

			<h1 class="text-4xl font-extrabold leading-[1.1] tracking-tight text-white sm:text-5xl md:text-7xl">
				Your productivity.<br />
				<span class="text-zinc-500">Your data. Your rules.</span>
			</h1>
			...
			<div class="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
				<a
					href="/dashboard"
					class="group flex items-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-semibold text-zinc-950 transition-all hover:bg-zinc-200"
				>
					Start for free
				...
				<a
					...
					target="_blank"
					rel="noopener noreferrer"
					class="flex items-center gap-2 rounded-xl border border-zinc-800 px-6 py-3 text-sm font-semibold text-zinc-300 transition-all hover:border-zinc-700 hover:bg-zinc-900"
				>
					<svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>
					View on GitHub
				</a>
		...
		<div class="relative mx-auto mt-20 max-w-5xl px-6">
			<div class="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-1.5 shadow-2xl shadow-black/50">
				<!-- Window chrome -->
			...
			<div class="pointer-events-none absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-zinc-950 to-transparent"></div>
		</div>
	</section>

	<!-- Integrations strip -->
	<section class="border-y border-zinc-800/50 py-12">
		<div class="mx-auto max-w-4xl px-6 text-center">
			<p class="mb-8 text-sm font-medium uppercase tracking-widest text-zinc-600">Powered by your Google account</p>
			<div class="flex flex-wrap items-center justify-center gap-10 md:gap-16">
				<!-- Google Calendar -->
				<div class="flex items-center gap-2 text-zinc-500">
					<svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="4" width="18" height="18" rx="2" /><path d="M16 2v4M8 2v4M3 10h18" /><path d="M8 14h2v2H8z" fill="currentColor" /></svg>
					<span class="text-sm font-medium">Calendar</span>
				</div>
				<!-- Google Tasks -->
				<div class="flex items-center gap-2 text-zinc-500">
					<svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M9 11l3 3L22 4" /><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11" /></svg>
					<span class="text-sm font-medium">Tasks</span>
				</div>
				<!-- Google Drive -->
				<div class="flex items-center gap-2 text-zinc-500">
					<svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 2L2 19.5h20L12 2z" /><path d="M2 19.5l5-8.5h14" /><path d="M15.5 11L22 19.5" /></svg>
					<span class="text-sm font-medium">Drive</span>
				</div>
				<!-- IndexedDB -->
				<div class="flex items-center gap-2 text-zinc-500">
					<svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><ellipse cx="12" cy="5" rx="9" ry="3" /><path d="M3 5v14c0 1.66 4.03 3 9 3s9-1.34 9-3V5" /><path d="M3 12c0 1.66 4.03 3 9 3s9-1.34 9-3" /></svg>
	...
	<section id="features" class="py-24 md:py-32">
		<div class="mx-auto max-w-6xl px-6">
			...
			<div class="mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
				<!-- Feature 1 -->
				<div class="group rounded-2xl border border-zinc-800/50 bg-zinc-900/30 p-6 transition-colors hover:border-zinc-700/50 hover:bg-zinc-900/50">
					<div class="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-zinc-800">
						<svg class="h-5 w-5 text-zinc-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
					</div>
					<h3 class="text-base font-semibold text-white">You own your data</h3>
				...
				<div class="group rounded-2xl border border-zinc-800/50 bg-zinc-900/30 p-6 transition-colors hover:border-zinc-700/50 hover:bg-zinc-900/50">
					<div class="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-zinc-800">
						<svg class="h-5 w-5 text-zinc-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
					</div>
					<h3 class="text-base font-semibold text-white">Offline first</h3>
					<p class="mt-2 text-sm leading-relaxed text-zinc-500">
				...
				<div class="group rounded-2xl border border-zinc-800/50 bg-zinc-900/30 p-6 transition-colors hover:border-zinc-700/50 hover:bg-zinc-900/50">
					<div class="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-zinc-800">
						<svg class="h-5 w-5 text-zinc-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" /></svg>
					</div>
					<h3 class="text-base font-semibold text-white">Tasks & notes</h3>
					<p class="mt-2 text-sm leading-relaxed text-zinc-500">
				...
				<div class="group rounded-2xl border border-zinc-800/50 bg-zinc-900/30 p-6 transition-colors hover:border-zinc-700/50 hover:bg-zinc-900/50">
					<div class="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-zinc-800">
						<svg class="h-5 w-5 text-zinc-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
					</div>
					<h3 class="text-base font-semibold text-white">Calendar view</h3>
					<p class="mt-2 text-sm leading-relaxed text-zinc-500">
				...
				<div class="group rounded-2xl border border-zinc-800/50 bg-zinc-900/30 p-6 transition-colors hover:border-zinc-700/50 hover:bg-zinc-900/50">
					<div class="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-zinc-800">
						<svg class="h-5 w-5 text-zinc-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
					</div>
					<h3 class="text-base font-semibold text-white">Install anywhere</h3>
					<p class="mt-2 text-sm leading-relaxed text-zinc-500">
				...
				<div class="group rounded-2xl border border-zinc-800/50 bg-zinc-900/30 p-6 transition-colors hover:border-zinc-700/50 hover:bg-zinc-900/50">
					<div class="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-zinc-800">
						<svg class="h-5 w-5 text-zinc-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" /></svg>
					</div>
					<h3 class="text-base font-semibold text-white">Smart reminders</h3>
					<p class="mt-2 text-sm leading-relaxed text-zinc-500">
	...
	<!-- How it works -->
	<section id="how-it-works" class="border-t border-zinc-800/50 py-24 md:py-32">
		<div class="mx-auto max-w-6xl px-6">
			<div class="mx-auto max-w-2xl text-center">
				<h2 class="text-3xl font-bold tracking-tight text-white md:text-4xl">How it works</h2>
				<p class="mt-4 text-lg text-zinc-400">Three simple principles. No magic, no lock-in.</p>
			</div>

			<div class="mt-16 grid gap-8 md:grid-cols-3">
				<!-- Step 1 -->
				<div class="relative">
					<div class="mb-6 flex h-12 w-12 items-center justify-center rounded-2xl border border-zinc-800 bg-zinc-900 text-lg font-bold text-zinc-400">1</div>
					<h3 class="text-lg font-semibold text-white">Sign in with Google</h3>
				...
				<!-- Step 2 -->
				<div class="relative">
					<div class="mb-6 flex h-12 w-12 items-center justify-center rounded-2xl border border-zinc-800 bg-zinc-900 text-lg font-bold text-zinc-400">2</div>
					<h3 class="text-lg font-semibold text-white">Work locally</h3>
					<p class="mt-3 text-sm leading-relaxed text-zinc-500">
				...
				<!-- Step 3 -->
				<div class="relative">
					<div class="mb-6 flex h-12 w-12 items-center justify-center rounded-2xl border border-zinc-800 bg-zinc-900 text-lg font-bold text-zinc-400">3</div>
					<h3 class="text-lg font-semibold text-white">Sync to Drive</h3>
					<p class="mt-3 text-sm leading-relaxed text-zinc-500">
	...
	<section class="border-t border-zinc-800/50 py-24 md:py-32">
		<div class="mx-auto max-w-6xl px-6">
			<div class="grid items-center gap-12 lg:grid-cols-2">
				<div>
					<h2 class="text-3xl font-bold tracking-tight text-white md:text-4xl">
						No backend.<br />
						<span class="text-zinc-500">Seriously.</span>
					</h2>
					...
					<div class="mt-8 space-y-3">
						<div class="flex items-center gap-3">
							...
							<span class="text-sm text-zinc-300">No database to maintain</span>
						</div>
						<div class="flex items-center gap-3">
							<svg class="h-5 w-5 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" /></svg>
							<span class="text-sm text-zinc-300">No server costs</span>
						</div>
						<div class="flex items-center gap-3">
							<svg class="h-5 w-5 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" /></svg>
							<span class="text-sm text-zinc-300">No data breaches possible</span>
						</div>
						<div class="flex items-center gap-3">
							<svg class="h-5 w-5 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" /></svg>
							<span class="text-sm text-zinc-300">Deploy as static files</span>
						</div>
					</div>
				</div>

				<!-- Code block -->
				<div class="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-1.5">
					<div class="flex items-center gap-2 px-4 py-3">
						...
						<span class="ml-2 text-xs text-zinc-600">store.ts</span>
					</div>
...
&#125;</code></pre>
	...
	<!-- Open source CTA -->
	<section id="open-source" class="border-t border-zinc-800/50 py-24 md:py-32">
		<div class="mx-auto max-w-4xl px-6 text-center">
			<div class="rounded-3xl border border-zinc-800/50 bg-gradient-to-b from-zinc-900/80 to-zinc-900/20 p-12 md:p-16">
				<div class="mb-6 inline-flex items-center gap-2 rounded-full border border-zinc-800 bg-zinc-950 px-4 py-1.5">
					<svg class="h-4 w-4 text-zinc-400" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>
					<span class="text-xs font-medium text-zinc-400">MIT License</span>
				</div>
				...
				<div class="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						class="flex items-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-semibold text-zinc-950 transition-colors hover:bg-zinc-200"
					>
						<svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>
						Star on GitHub
					</a>
					<a
						href="/dashboard"
						class="rounded-xl border border-zinc-700 px-6 py-3 text-sm font-semibold text-zinc-300 transition-all hover:border-zinc-600 hover:bg-zinc-900"
					>
						Try the app
					</a>
				</div>
	...
	<footer class="border-t border-zinc-800/50 py-12">
		<div class="mx-auto max-w-6xl px-6">
			...
			<div class="mt-8 border-t border-zinc-800/50 pt-8 text-center">
				<p class="text-xs text-zinc-700">&copy; {new Date().getFullYear()} myP0. Open source under the MIT License.</p>
			</div>
		</div>
	</footer>
</div>
